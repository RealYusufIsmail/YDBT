...
exports.Kick = {
    ...
    run: async (client, interaction, play, db) => {
        ...
        await (0, MongoDB_1.updateModerationDatabase)(db, interaction.guild.id, member.id, reason, TypeOfModeration_1.TypeOfModeration.KICK);
        await interaction
            ...
            .catch(() => {
            interaction.reply({
                content: 'Could not kick the provided member',
                ephemeral: true
            });
        });
    }
