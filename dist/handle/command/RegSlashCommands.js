...
exports.RegSlashCommands = [Help_1.Help, Ping_1.Ping, UserInfo_1.UserInfo, info_1.Info, Ban_1.Ban, UnBan_1.UnBan, Kick_1.Kick, DeleteMessages_1.DeleteMessages, TimeOut_1.TimeOut, Play_1.Play, PlayList_1.PlayList, RemoveLoop_1.RemoveLoop,
    ToggleLoop_1.ToggleLoop, ToggleQueueLoop_1.ToggleQueueLoop, Skip_1.Skip, Stop_1.Stop, GetQueue_1.GetQueue, ClearQueue_1.ClearQueue, Pause_1.Pause, Resume_1.Resume, NowPlaying_1.NowPlaying, SongProgress_1.SongProgress];
const getCommands = () => {
